...
public abstract class Role
{
	...
	{
		if(_person != null) { if (_person.getName().equals("Yixin7")) print("should wake up"); _person.stateChanged(); }// this checking for _person != null is necessary in cases like when the cook sends a message to a market whose cashier role isn't yet filled 
